...
if program_start:
    ...
    initial_altitude = Altitude.get_altitude(Altitude.A0, Altitude.callibrate_init_pressure(samples=20))
    ...
    while True:
        ...
        the_time.fd.append(Extra.round_down_thousandths(MissionTime.get_total_time(MissionTime.get_time(), start_time)))
